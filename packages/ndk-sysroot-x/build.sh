...
TERMUX_PKG_CONFLICTS="libutil-dev, ndk-sysroot, libgcc"
TERMUX_PKG_REPLACES="libutil-dev, ndk-sysroot, libgcc"
TERMUX_PKG_PROVIDES="libutil-dev, ndk-sysroot, libgcc"
...
termux_step_extract_into_massagedir () {
    ...
    ## compatibility with libmesa-dev
    rm -rf $TERMUX_PKG_MASSAGEDIR/$TERMUX_PREFIX/include/KHR
}
